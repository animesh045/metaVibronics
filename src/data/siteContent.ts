...
export interface SiteContent {
  ...
  hero: {
    eyebrow: string;
    titleHtml: string; // "Build<em>ing</em><br>brands<br>that<br>last."
    subtitle: string;
    stats: StatItem[];
  ...
  about: {
    eyebrow: string;
    headingHtml: string; // "Two founders. One studio. <em>Every project.</em>"
    founders: Founder[];
    quoteHtml: string; // "Systems <em>+</em> Story <em>=</em> Brands that connect, communicate, and grow."
  };
  services: {
    eyebrow: string;
    headingHtml: string;
...
export const defaultSiteContent: SiteContent = {
  ...
  hero: {
    ...
    stats: [
      ...
      { value: "₹1.11", label: "Best CPC Achieved", highlighted: true },
      { value: "8", label: "Industries" },
    ],
    pillars: [
      { name: "Brand Systems", description: "Identity · Guidelines · Positioning" },
      { name: "Communication Design", description: "Presentations · Publications · Infographics" },
      { name: "Digital Experiences", description: "UI/UX · Design Systems · Landing Pages" },
      { name: "Content & Growth", description: "Social · Ads · Performance Marketing" },
      { name: "Production & Packaging", description: "Print · Packaging · Event Branding" },
    ],
  },
  about: {
    ...
    cards: [
      {
        ...
        num: "01",
        title: "Brand Systems",
        items: ["Identity & Visual Language", "Brand Guidelines", "Positioning & Naming", "Typography Systems", "Colour & Tone"],
      },
      {
        id: "svc-2",
        num: "02",
        title: "Communication Design",
        items: ["Pitch Decks & Presentations", "Publications & Brochures", "Infographics", "Data Visualisation", "Company Profiles"],
      },
      {
        id: "svc-3",
        num: "03",
        title: "Digital Experiences",
        items: ["UI/UX Design", "Wireframes & Prototypes", "Design Systems", "Landing Pages", "Responsive Web"],
      },
      {
        id: "svc-4",
        num: "04",
        title: "Content & Growth",
        items: ["Social Media Management", "Meta & Google Ads", "Performance Marketing", "Lead Generation", "Campaign Strategy"],
      },
      {
        id: "svc-5",
        num: "05",
        title: "Production & Packaging",
        items: ["Packaging Design", "Print Production", "Event Branding", "ID Cards & Certificates", "Promotional Material"],
      },
    ],
    industries: [
      { emoji: "🏥", name: "Healthcare & Dental" },
      { emoji: "🧬", name: "Wellness & Nutraceuticals" },
      { emoji: "💻", name: "Technology & SaaS" },
      { emoji: "🏗️", name: "Construction & Infrastructure" },
      { emoji: "🎓", name: "Education & Institutions" },
      { emoji: "🚗", name: "Automotive" },
      { emoji: "🛍️", name: "Retail & E-Commerce" },
      { emoji: "👤", name: "Personal Brands & Authors" },
    ],
  },
  work: {
    eyebrow: "Our Work",
    ...
    projects: [
      {
        ...
        deliverables: ["Product cards for 8+ SKUs (Longevity+, PurMidine, CREAGEN range, CellVivo)", "Product catalogue", "Ingredient communication", "Packaging layouts", "Brand consistency across all formats"],
  ...
  results: {
    ...
    stats: [
      { value: "15+", label: "Brands Served" },
      { value: "200+", label: "Creative Assets Delivered" },
      { value: "8", label: "Industries" },
      { value: "₹1.11", label: "Best CPC Achieved", highlighted: true },
      { value: "16K+", label: "Organic Views / Cycle" },
      { value: "30+", label: "Long-form Videos Edited" },
    ],
  },
  outcomes: {
    ...
    items: [
      { num: "01", title: "One unified brand system", desc: "Not scattered posts from three different people." },
      { num: "02", title: "Two specialists, not one generalist", desc: "Strategy + design + content under one brief." },
      { num: "03", title: "Two founders on every project", desc: "No juniors. No handoffs. No guesswork." },
      { num: "04", title: "Print-ready and digital-ready", desc: "Same brief, every format, zero extra briefing." },
      { num: "05", title: "Faster execution, less coordination", desc: "You focus on your business. We handle the brand." },
      { num: "06", title: "Work that looks international", desc: "Because some of it already is." },
    ],
  },
  process: {
    eyebrow: "Process",
    ...
    steps: [
      { num: "01", title: "Discover", desc: "We learn your brand, audience, goals, and existing assets before touching anything creative." },
      { num: "02", title: "Strategise", desc: "We map your communication needs and design the right system for your stage and goals." },
      { num: "03", title: "Design", desc: "We execute across all formats — digital, print, motion — from one brief, with zero fragmentation." },
      { num: "04", title: "Launch", desc: "We deploy, manage, and maintain across platforms, campaigns, and touchpoints." },
      { num: "05", title: "Optimise", desc: "We review results, track what works, and refine the system continuously." },
    ],
  },
  pricing: {
    eyebrow: "Pricing",
  ...
  contact: {
    ...
    fields: [
      { label: "Your Name", type: "text", placeholder: "Rajesh Kumar", required: true },
      { label: "Email Address", type: "email", placeholder: "rajesh@company.com", required: true },
      { label: "Phone (optional)", type: "tel", placeholder: "+91 98765 43210" },
      { label: "Service Interested In", type: "select", placeholder: "Select a service" },
      { label: "Tell us about your project", type: "textarea", placeholder: "Share anything about your business..." },
    ],
  },
};
